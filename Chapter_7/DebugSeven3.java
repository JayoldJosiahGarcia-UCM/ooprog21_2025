...
public class DebugSeven3
{
    public static void main(String[] args)
    {
        ...
        quote = kb.nextLine(); // added variable kb
        System.out.print("Enter a character to search for >> ");
        charString = kb.nextLine(); //changed nextInt to nextLine
        searchChar = charString.charAt(0);
        System.out.println("index of('" + searchChar + "') is: " +
            quote.indexOf(searchChar)); // add parenthesis
        System.out.println("indexOf('a') is: " + quote.indexOf('a')); //add parenthesis 
        ...
        System.out.println("replace('e', '*') is: " +
            quote.replace('e', '*')); // fixed typo repplace to replace
    }
}
